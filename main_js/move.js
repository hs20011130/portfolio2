...
$(document).ready(function() {
    ...
    $('.btn1').css('background','#6C4AB6').css('border','2px solid transparent'); //첫번째 불켜
   ...
   // $('.gallery .link1 span').delay(1500).animate({top:170, opacity:1},'slow');
    ...
    //   }
      ...
      $('.mbutton').css('background','none').css('border','2px solid #fff'); //버튼불다꺼!!
      //$('.mbutton').css('width','16px'); // 버튼 원래의 너비
      $('.btn'+cnt).css('background','#6C4AB6').css('border','2px solid transparent');//자신만 불켜
