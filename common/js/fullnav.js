...
//글로벌 네비게이션 코드
   ...
   var on_off=false;  //false(안오버)  true(오버)
    ...
    //상단 top 이동 코드
 $('.top_move').click(function(e){e.preventDefault();
   $('html, body').stop().animate({'scrollTop':0},1000); //상단으로 부드럽게 스크롤을 이동
 });

$(window).on('scroll',function(){//스크롤의 위치의 변화가 생기면..
